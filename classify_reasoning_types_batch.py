...
def setup_args() -> Namespace:
    ...
    parser.add_argument("--gcs_upload_prefix", type=str, default="gs://appier-ai-research-dev/multilingual-reasoning/cotscope/reasoning_kind_classification/batch_prediction_input")
    parser.add_argument("--gcs_download_prefix", type=str, default="gs://appier-ai-research-dev/multilingual-reasoning/cotscope/reasoning_kind_classification/batch_prediction_output")
